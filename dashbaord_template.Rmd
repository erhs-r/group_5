---
title: "Coronavirus and Election Data"
...
###  **Comparing Mask-wearing Adherence for Three State and its Counties**

##### **States are in order of highest, middle, and lowest number of Coronavirus cases per 100000 people.** 
...
- [COVID-19](https://github.com/nytimes/covid-19-data)
    + Cumulative counts of COVID-19 cases and deaths reported by local governments
- [Mask-use by Counties](https://github.com/nytimes/covid-19-data/tree/master/mask-use) 
    + 250,000 survey responses between July 2, 2020 and July 14, 2020  
    + How often do you wear a mask in public when you expect to be within six feet of another person?
    
##### **TidyCensus**
- [Census Data](https://walker-data.com/tidycensus/articles/basic-usage.html)  
    +

##### **Presidential Election Results**
- [County Election Data](https://github.com/favstats/USElection2020-NYT-Results/blob/master/README.Rmd)
    +
...
- [New York Times Map](https://www.nytimes.com/interactive/2020/us/coronavirus-us-cases.html)
- [John Hopkins Coronavirus Map](https://coronavirus.jhu.edu/map.html) 
- [New York Times States' Restrictions and Outbreak](https://www.nytimes.com/interactive/2020/11/18/us/covid-state-restrictions.html) 
...
##### **Mask-wearing Adherence by Cases and States**
    
This pane depicts three states selected based on their number of COVID-19 cases per 100K people.The highest, middle, and lowest number of cases per 100k people are shown respectively from right to left. Each circle represents a county and the circle size represents how many cases per 100k is in the county. Each county is plotted based on the their reporting of how often they always or frequently wear their mask. Also, more information is provided when one hovers over one county. Finally, the counties are either blue or red to represent whichever candidate receives over 50% majority vote.
